            ...
            <label class="flex flex-col min-w-40 h-12 w-full">
                <div class="flex w-full flex-1 items-stretch rounded-xl h-full">
                    ...
                    <div class="flex justify-between w-full gap-4 items-center">
                        <form class="w-full">
                            <input wire:model.live="query" placeholder="Cari Produk"
            ...
            <div class="flex overflow-hidden rounded-xl border border-[#436039] bg-[#162013]">
                <table class="flex-1">
                    ...
                    <tbody>
                        @forelse ($products as $product)
                            <tr class="border-t border-t-[#436039]">
                                ...
                                <td
                                    ...
                                    <a href="/dashboard/{{ $product->id }}/edit" class="text-green-500 me-1">Edit</a>
                                    |
                                    <form wire:submit.prevent="destroy({{ $product->id }})"
                                        class="ms-1 text-red-500 inline">
                                        <button class="cursor-pointer">Hapus</button>
                                    </form>
                                    <form wire:submit.prevent="updateishide({{ $product->id }})"
                                        class="text-gray-400 ">
                                        @if ($product->ishide)
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center text-sm text-white p-2">Tidak Ada Data</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
