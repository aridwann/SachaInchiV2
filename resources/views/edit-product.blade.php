                    ...
                    <div class="w-full md:w-1/2">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" id="description" rows="6"
                                class="w-full bg-[#2f4328] border border-[#436039] text-white rounded-lg p-3 focus:ring-[#54D12B] focus:border-[#54D12B]">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
